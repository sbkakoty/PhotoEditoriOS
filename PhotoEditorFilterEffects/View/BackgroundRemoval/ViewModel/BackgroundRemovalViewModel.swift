...
class BackgroundRemovalViewModel: NSObject {
    
    func uploadRequest(imageDataOriginalImage: Data?, completion: @escaping (_ data: String?, _ error: String?) -> ()) {
        ...
        AF.upload(multipartFormData: { formData in
           ...
           to: "\(AppConfig.picwishEndPoint)/api/tasks/visual/segmentation",
           headers: [
    ...
    func fetchFinalImage(task_id: String?, completion: @escaping (_ data: Data?, _ error: String?) -> ()) {
        ...
        AF.request(
            "\(AppConfig.picwishEndPoint)/api/tasks/visual/segmentation/\(task_id!)",
            method: .get,
