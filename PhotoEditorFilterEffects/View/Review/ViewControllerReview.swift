...
class ViewControllerReview: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let masterView = UINib(nibName: "MasterViewReview", bundle: nil).instantiate(withOwner: nil, options: nil)[0] as! UIView
        masterView.backgroundColor = UIColor(hexaRGB: getBackgroundColor())!
        masterView.translatesAutoresizingMaskIntoConstraints = false
        
        self.title = NSLocalizedString("actionSheetReviewReference", comment: "")
